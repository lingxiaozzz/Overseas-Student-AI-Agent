...
- Run `python -m eval.observability_report` to aggregate success, routing, average/P95 latency, cache hits, tool/replan use, evaluation pass rate, and feedback; use `--data-dir` for exported production runtime data
